        ...
        if (chooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                if (archivoXLS.exists()) {
                      int opcion = JOptionPane.showConfirmDialog(MainSystem.getFrames()[0], 
                              "El archivo ya existe!, ¿desea remplazarlo?", "Aviso", JOptionPane.OK_CANCEL_OPTION);
                    if (opcion == 0) {
                        archivoXLS.delete();
                ...
                archivo.close();
               JOptionPane.showMessageDialog(MainSystem.getFrames()[0], "Archivo exportado en " + ruta);
