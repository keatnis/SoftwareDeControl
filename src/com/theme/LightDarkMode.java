...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/theme/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/theme/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("com/theme/light.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("com/theme/dark.svg"));
        }
    }
